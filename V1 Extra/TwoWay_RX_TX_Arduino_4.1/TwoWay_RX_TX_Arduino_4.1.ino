...
//    
//      uint8_t TwoWire_SlaveIP_Result;
//  for ( uint8_t I = 0; I < TwoWire_G_SlaveIPCount; I++) {
...
//    }
//  }
//    TwoWire_Buffer[TwoWire_SlaveIP][((TwoWire_G_BufferSize * TwoWire_G_SlaveIPCount) + 2 + TwoWire_SlaveIP_Result)][0]--;
//    return true;
//  }
//  else {
...
//      uint8_t TwoWire_BufferTest = TwoWire_Buffer[TwoWire_SlaveIP_Result][((TwoWire_G_BufferSize * TwoWire_G_SlaveIPCount) + 1)][1];
//      if (TwoWire_Buffer[TwoWire_SlaveIP_Result][((TwoWire_G_BufferSize * TwoWire_G_SlaveIPCount) + 1)][1] == (TwoWire_G_BufferSize * TwoWire_G_SlaveIPCount)) {
//        TwoWire_BufferTest = 0;
//      }
//      else {
//        TwoWire_BufferTest++;
//      }
//      if (TwoWire_BufferTest == TwoWire_Buffer[TwoWire_SlaveIP_Result][((TwoWire_G_BufferSize * TwoWire_G_SlaveIPCount) + 1)][0]) {
//        return false;
//      }
//      else {
//        if(TwoWire_Buffer[TwoWire_SlaveIP_Result][((TwoWire_G_BufferSize * TwoWire_G_SlaveIPCount) + 2 + TwoWire_SenderIP)][0] < TwoWire_G_BufferSize){
//          TwoWire_Buffer[TwoWire_SlaveIP_Result][((TwoWire_G_BufferSize * TwoWire_G_SlaveIPCount) + 2 + TwoWire_SenderIP)][0]++;
//        TwoWire_Buffer[TwoWire_SlaveIP_Result][((TwoWire_G_BufferSize * TwoWire_G_SlaveIPCount) + 1)][1] = TwoWire_BufferTest;
//        TwoWire_Buffer[TwoWire_SlaveIP_Result][TwoWire_Buffer[TwoWire_SlaveIP_Result][((TwoWire_G_BufferSize * TwoWire_G_SlaveIPCount) + 1)][1]][0] = TwoWire_G_SlaveIP[TwoWire_SenderIP];
//        TwoWire_Buffer[TwoWire_SlaveIP_Result][TwoWire_Buffer[TwoWire_SlaveIP_Result][((TwoWire_G_BufferSize * TwoWire_G_SlaveIPCount) + 1)][1]][1] = TwoWire_Data;
//        return true;
//        }
//        else{
//          return false;
...
void loop() {
  Check_Interval();
//  if(!digitalRead(12) and ButtonState){
//    TwoWire_TX_Buffer[0] = 4;
//    TwoWire_TX_Buffer[1] = 31;
//    TwoWire_Run(1);
//    ButtonState = false;
//    TwoWire_TX_Buffer[0] = 2;
//    if(LEDState){
//    TwoWire_TX_Buffer[1] = 111;
//    LEDState = false;
//  }
//  else{
//    TwoWire_TX_Buffer[1] = 222;
//     LEDState = true;
//  }
//  }
//  if(digitalRead(12) and !ButtonState){
//    TwoWire_TX_Buffer[0] = 4;
//    TwoWire_TX_Buffer[1] = 13;
//    TwoWire_Run(1);
//    ButtonState = true;
//    TwoWire_TX_Buffer[0] = 2;
//    if(LEDState){
...
//  }
 if(TwoWire_Run(1)){
  ...
  if(TwoWire_Run(0)){
    if(TwoWire_RX_Buffer[0] == 2 and TwoWire_RX_Buffer[1] == 111){
      digitalWrite(13,HIGH);
    }
    if(TwoWire_RX_Buffer[0] == 2 and TwoWire_RX_Buffer[1] == 222){
      digitalWrite(13,LOW);
    }
//    if(TwoWire_RX_Buffer[0] == 1 and TwoWire_RX_Buffer[1] == 13){
//      digitalWrite(12,LOW);
//    }
//    if(TwoWire_RX_Buffer[0] == 1 and TwoWire_RX_Buffer[1] == 31){
