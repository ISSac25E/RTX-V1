...
//            case 3:
//              TwoWire_CheckBuffer = BufferRX(I);
//              TwoWire_CompileMessage(TwoWire_G_SlaveIP[I], TwoWire_Command(1, TwoWire_CheckBuffer, TwoWire_BufferStore(I, TwoWire_RX_Buffer[3], TwoWire_RX_Buffer[4])), TwoWire_BufferSend[0], TwoWire_BufferSend[1], TwoWire_CheckBuffer);
//              if (TwoWire_Safe()) {
//                TwoWire_Send();
//              }
//              TwoWire_CheckConnectionInterval(I, 1);
...
void loop() {
    ...
    TwoWire_Run(0);
  if(TwoWire_Status[0]){
    if(TwoWire_RX_Buffer[1] == 111){
      digitalWrite(13,LOW);
    }
    if(TwoWire_RX_Buffer[1] == 222){
      digitalWrite(13,HIGH);
    }
    }
