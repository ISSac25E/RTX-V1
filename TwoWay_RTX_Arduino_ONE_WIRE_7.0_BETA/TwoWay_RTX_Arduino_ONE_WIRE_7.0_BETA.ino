...
uint8_t const TwoWire_G_SlaveIP[] = {1, 2, 3, 4, 5, 6, 7};
...
//
//bool TwoWire_G_Status[7];   //[RX, TX, TXS, Connected, MasterError, DuplicateIP, ERROR]
//
...
//  pinMode(13,OUTPUT);
//  TwoWire_G_BufferTX[0] = 2;
//}
//
//void loop() {
//  if(TwoWire_RTXMessage(0)) Serial.write(TwoWire_G_BufferRX[1]);
//  if(Serial.available()){
//    TwoWire_G_BufferTX[1] = Serial.read();
