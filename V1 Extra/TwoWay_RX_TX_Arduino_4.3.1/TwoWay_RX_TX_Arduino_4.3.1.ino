...
//  if (!TwoWireO_PinRead(1)) return TwoWireE_BitRead(TwoWireD_T_LengthOne, TwoWireD_T_LengthTwo);
//  return false;
//}
//
...
//    if (TwoWire_G_Buffer[TwoWireJ_T_SlaveIP][(TwoWire_G_SlaveIPCount * TwoWire_G_BufferSize) + 1][0] < (TwoWire_G_SlaveIPCount * TwoWire_G_BufferSize))
